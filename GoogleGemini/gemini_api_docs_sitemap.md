...
/gemini-api/docs/code-execution
 ...
 Grounding with Google Search
  ...
  |= /gemini-api/docs/grounding/search-suggestions
...
-Safety
  ...
  |=/gemini-api/docs/safety-guidance

-Additional resources  
  |
  |=/gemini-api/docs/migrate
  |=/gemini-api/docs/ai-studio-quickstart
  |=/gemini-api/docs/learnlm
  |=/gemini-api/docs/migrate-to-cloud
  |=/gemini-api/docs/oauth
  |=/gemini-api/docs/troubleshoot-ai-studio
  |=/gemini-api/docs/workspace
  
## Resources

/gemini-api/docs/changelog
/gemini-api/docs/troubleshooting
/gemini-api/docs/gemini-for-research
/gemini-api/terms
/gemini-api/docs/available-regions
/gemini-api/docs/usage-policies
